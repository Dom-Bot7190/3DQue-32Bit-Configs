...
#define X_HOMING_BUMP_DIVISOR 2
#define Y_HOMING_BUMP_DIVISOR 2
#define Z_HOMING_BUMP_DIVISOR 4
...
//#define LCD_SHOW_E_TOTAL
  ...
  #define SD_FINISHED_RELEASECOMMAND "M84XE"  // Use "M84XYE" to keep Z enabled so your bed stays in place
