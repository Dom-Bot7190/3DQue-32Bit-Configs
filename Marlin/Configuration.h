...
#define CUSTOM_MACHINE_NAME "3DQue 2.0.2 V2"
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -35.65, -5, 0 }
...
#define Z_PROBE_SPEED_FAST 3500

// Feedrate (mm/m) for the "accurate" probe of each point
#define Z_PROBE_SPEED_SLOW 1500
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT ((X_BED_SIZE - 10)/2)  // X point for Z homing when homing all axes (G28). Change to X_CENTER on update
  #define Z_SAFE_HOMING_Y_POINT ((Y_BED_SIZE - 10)/2)  // Y point for Z homing when homing all axes (G28). Change  Y_CENTER
#endif
